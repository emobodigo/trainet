    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Add New Instructure</h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_content">  
                            <br />
                            <?php echo form_open_multipart('Admin/tambahInstruktur') ?>
                            <div class="form-horizontal form-label-left">
                                <div class="col-md-10 col-sm-10 col-xs-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="level" class="form-control col-md-7 col-xs-12" type="text" name="level" value="1" readonly>
                                    ...
                                    <div class="form-group">
                                        <label for="middle-name" class="control-label col-md-2 col-sm-3 col-xs-12">Sport</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="sport" class="form-control col-md-7 col-xs-12" type="text" name="sport" required="required">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="middle-name" class="control-label col-md-2 col-sm-3 col-xs-12">Cost</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="cost" class="form-control col-md-7 col-xs-12" type="number" name="cost" required="required">
                                        </div>
                                    </div>
                                    <div class="form-group">
